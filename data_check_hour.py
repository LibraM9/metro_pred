...
train_in = data[["stationID","day","hour","inNums"]]
train_out = data[["stationID","day","hour","outNums"]]
...
def station_plot(station):
    ...
    f, ax = plt.subplots(n_fig_x, n_fig_y, figsize=(60, 30))
    ...
    for i in range(len(time_list_sub)):
        try:
            ...
            continue
    plt.savefig("F:/数据集处理/1903地铁预测/fig_holiday_hour/{}.jpg".format(str(station)))

files = os.listdir("F:/数据集处理/1903地铁预测/fig_holiday_hour")
